function [yn,en,yfb,S] = HALMSadapt(un,S)

% HALMSadapt      Adaptive FIR Filter with LMS Algorithm for Hearing Aids
% 
%                 The history of output, square error and coefficients of 
%                 FIR filters are passed out to extenal. Refer to Fig. 1.9 
%                   
% Arguments:
% un              Input signal to hearing aids
% S               Adptive filter parameters as defined in HALMSinit.m
...
mu = S.step;                   % Step size for the NLMS algorithm
