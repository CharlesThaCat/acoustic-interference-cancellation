function [en,S] = MSAFadapt_oplp(un,dn,S)

% MSAFadapt_oplp    Open-Loop Implementation of Delayless Multiband-structured SAF
%
% Arguments: 
% un                Input signal
% dn                Desired signal
...
a = zeros(L,1); A = zeros(L,N); d = zeros(L,1);    % For analysis filtering
